...
<InstallOneLiner tool="fab-kit" />

## How it fits

`fab-kit` is the engine of the loop: it turns an **[idea](/idea/)** backlog item into a planned change (via `/fab-new`), runs that change inside a disposable **[wt](/wt/)** worktree, and you watch every agent session from the **[run-kit](/docs/)** dashboard.

## Where to next

- **[Readme](/fab-kit/readme/)** — the full canonical guide, synced from fab-kit's own repo.
- **[Commands](/fab-kit/commands/)** — every subcommand and flag.
