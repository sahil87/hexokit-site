...
`shll` is the bootstrap for everything else — see [Install everything](/toolkit/install/) to set up the toolkit in one go. From there the loop runs: **[idea](/idea/)** captures work, **[fab-kit](/fab-kit/)** plans it, **[wt](/wt/)** isolates it, and **[run-kit](/docs/)** watches it.
